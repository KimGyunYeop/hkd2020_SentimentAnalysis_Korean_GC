...
class BaseDataset(Dataset):
    def __init__(self, args, tokenizer, mode):
        ...
        if "train" in mode:
            data_path = os.path.join(args.data_dir, args.data_dir, args.data_dir, args.train_file)
        elif "dev" in mode:
            data_path = os.path.join(args.data_dir, args.data_dir,args.data_dir,  args.dev_file)
        elif "test" in mode:
